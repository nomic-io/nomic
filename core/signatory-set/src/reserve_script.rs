...
mod tests {
    ...
    fn redeem_script_fixture() {
        ...
        assert_eq!(
            script.into_bytes(),
            vec![
                33, 3, 70, 39, 121, 173, 74, 173, 57, 81, 70, 20, 117, 26, 113, 8, 95, 47, 16, 225, 199, 165, 147, 228, 224, 48, 239, 181, 184, 114, 28, 229, 91, 11, 172, 99, 84, 103, 0, 104, 124, 33, 2, 83, 31, 230, 6, 129, 52, 80, 61, 39, 35, 19, 50, 39, 200, 103, 172, 143, 166, 200, 60, 83, 126, 154, 68, 195, 197, 189, 189, 203, 31, 227, 55, 172, 99, 83, 147, 104, 124, 33, 2, 77, 75, 108, 209, 54, 16, 50, 202, 155, 210, 174, 185, 217, 0, 170, 77, 69, 217, 234, 216, 10, 201, 66, 51, 116, 196, 81, 167, 37, 77, 7, 102, 172, 99, 82, 147, 104, 124, 33, 3, 27, 132, 197, 86, 123, 18, 100, 64, 153, 93, 62, 213, 170, 186, 5, 101, 215, 30, 24, 52, 96, 72, 25, 255, 156, 23, 245, 233, 213, 221, 7, 143, 172, 99, 81, 147, 104, 86, 160, 105, 3, 1, 2, 3, 81
            ]
        );
    }
    ...
    fn output_script_fixture() {
        ...
        assert_eq!(
            script.into_bytes(),
            vec![0, 32, 125, 122, 168, 200, 18, 6, 85, 240, 65, 153, 18, 195, 77, 189, 61, 140, 13, 30, 255, 94, 38, 110, 170, 206, 226, 103, 163, 195, 181, 207, 79, 11]
        );
    }
}
