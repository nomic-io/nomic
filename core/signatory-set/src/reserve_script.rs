...
mod tests {
    ...
    fn output_script_fixture() {
        ...
        assert_eq!(
            script.into_bytes(),
            vec![
                0, 32, 115, 21, 95, 116, 204, 238, 80, 17, 195, 198, 39, 118, 193, 90, 188, 192, 212, 225, 158, 179, 225, 118, 70, 9, 207, 62, 144, 231, 203, 129, 219, 74
            ]
        );
    }
