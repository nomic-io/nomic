...
export function oraibtc_new(a: number, b: number, c: number, d: number, e: number): number;
...
export function oraibtc_generateDepositAddress(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number): number;
