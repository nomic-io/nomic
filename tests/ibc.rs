...
async fn direct_deposit_bitcoin(
    ...
    let dest = Dest::Ibc(nomic::app::IbcDest {
        ...
        sender: EdAdapter(sender.into()),
        receiver: EdAdapter(receiver.into()),
...
async fn ibc_test() {
    ...
    let test = async {
        ...
        let ibc_dest = IbcDest {
            ...
            source_channel: "channel-0".try_into().unwrap(),
            receiver: EdAdapter(
                "cosmos1vd0r7t04vnr36x6pydel9eacvn776psehknf74"
                    .to_string()
                    .try_into()
                    .unwrap(),
            ),
            sender: EdAdapter(funded_accounts[0].address.to_string().into()),
            timeout_timestamp,
        ...
        Command::new("hermes")
            .args([
                ...
                "300",
                "--memo",
                &format!("withdraw:{}", funded_accounts[0].bitcoin_address()),
            ])
            .spawn()
            .unwrap()
            .wait()
        ...
        let balance = balances["balances"]
            ...
            .unwrap();
        assert_eq!(balance["amount"], "5812848127");
        ...
        app_client()
            .with_wallet(funded_accounts[0].wallet.clone())
            .call(
                |app| build_call!(app.bitcoin.transfer_to_fee_pool(1000000000.into())),
                |app| build_call!(app.app_noop()),
            )
            .await
            .unwrap();
        ...
        let balance = balances["balances"]
            ...
            .unwrap();
        assert_eq!(balance["amount"], "49254577538527");
