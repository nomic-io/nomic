use super::peg::handlers::signatories_from_validators;
use super::spv::headercache::HeaderCache;
...
impl MockNet {
    ...
    pub fn with_btc_block(initial_block: bitcoin::Block) -> Self {
        ...
        super::peg::handlers::begin_block(&mut state, &mut net.validators, header).unwrap();
...
pub fn create_sender<S: Store>(
    accounts: &mut super::accounts::State<S>,
    balance: u64,
    nonce: u64,
) -> Sender {
