...
Vulnerabilities should not be reported through public channels, including GitHub Issues. You can report a via GitHub's Private Vunerability Reporting or via `foundation@nomic.io`.
